...
:::caution Coming Soon
Configurable Fees are not yet available for general use. This documentation is published in advance so platforms can prepare for the rollout.
:::
...
1. **Configure** fee rates for a sub account via the [Create Fee Configuration](./managingConfigurations.mdx#creating-a-configuration) endpoint or through the JustiFi dashboard
