...
:::warning Required Fee Types Cannot Have an Effective End Date
The following fee types are **required** once configured and do **not** accept an `effective_end` parameter:
