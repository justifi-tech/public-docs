...
To upload evidence for the dispute you can either use the [Dispute Management web component](https://storybook.justifi.ai/?path=/docs/payment-facilitation-dispute-management--docs) or the [create dispute evidence API](https://docs.justifi.tech/api-spec#tag/Disputes/operation/UpdateDispute) and submit [Dispute Response API](https://docs.justifi.tech/api-spec#tag/Disputes/operation/UpdateDisputeResponse)
