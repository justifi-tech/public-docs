...
[Get in touch with us](https://docs.justifi.tech/contact) and learn all the ins and outs about the JustiFi Unified Card Present program.

<!--
## Having trouble with your device?
Check the following if your device isn't working as expected:

Please reach out to [JustiFi Customer Success](mailto:customer_success@justifi.tech)
-->
