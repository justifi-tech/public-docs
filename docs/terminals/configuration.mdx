...
You can find the device ID in the Welcome Email from Verifone.\
...
and in the **"Terminals List"** on the JustiFi dashboard. (Go to https://app.justifi.ai/ and choose **“Terminals”** from the **"Payments"** dropdown.)
...
**A:** If the welcome email is missing and your package was sent from Verifone, check the packaging list affixed to the terminal's box. 
