...
or on the JustiFi dashboard on the 
as soon as the terminal order was created and anytime after. The nickname can also be changed using the same API endpoint.
...
**A:** If your package was sent from Verifone, check the packaging list affixed to the terminal's box. 
The 8 digit DID is listed under “Reference” on the bottom of the packaging list.\
If you can't find either or your package was not sent from Verifon please contact [JustiFi Customer Success](mailto:platform_success@justifi.tech).