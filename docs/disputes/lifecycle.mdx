...
If you choose not to contest the dispute you should make a `POST` request to `/disputes/{id}/response` with the following body:
...
#### Lost (`lost` status)
- **Funds Retained**: Funds return to the cardholder
