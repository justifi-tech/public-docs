...
3. Implement dispute response workflows in your application via [Dispute Management Web Component](/web-components/payment-facilitation/dispute-management/index) or via [disputes API](https://docs.justifi.tech/api-spec#tag/Disputes)
