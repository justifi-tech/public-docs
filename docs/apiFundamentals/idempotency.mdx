...
- **String Identifier:** You can use any string up to 100 characters long as your `Idempotency-Key`. We recommend using
...
- **Character Limit:** If the length of the key exceeds 100 characters a 422 error 
  `Validation failed: Idempotency key is too long (maximum is 100 characters)` is returned.
