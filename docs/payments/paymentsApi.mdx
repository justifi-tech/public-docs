...
**[JustiFi Payment Method Web Component](/web-components/)** to securely collect and tokenize
card or bank account details. The web component returns a payment method token that you pass
...
> approval. Contact JustiFi support if you have a use case that requires direct PAN submission.
...
- **Reduced PCI Scope:** By using JustiFi's Payment Method Web Component to tokenize payment
