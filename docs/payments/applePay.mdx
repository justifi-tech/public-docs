...
- [Unified Fintech Checkout web component](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index) 
- [Modular Checkout web component](/web-components/modular-checkout/introduction/index)

Apple Pay is not available in the [Tokenize Payment Method web component](/web-components/payment-facilitation/tokenize-payment-method/index) or via API.
...
[Unified Fintech Checkout](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index) 
or [Modular Checkout](/web-components/modular-checkout/introduction/index) web component)
...
For more details refer to the [Modular Checkout docs](/web-components/modular-checkout/introduction/index)
