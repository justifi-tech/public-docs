...
- [Modular Checkout web component](https://storybook.justifi.ai/?path=/docs/modular-checkout--docs)

Apple Pay is not available in the [Tokenize Payment Method web component](https://storybook.justifi.ai/?path=/docs/payment-facilitation-tokenize-payment-method--docs) or via API.
...
or [Modular Checkout](https://storybook.justifi.ai/?path=/docs/modular-checkout--docs) web component)
...
For more details refer to the [Modular Checkout docs](https://storybook.justifi.ai/?path=/docs/modular-checkout--docs)
