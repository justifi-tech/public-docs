...
## Refunds
CAD payments can be refunded the same way as USD payments with the following differences:
- Refund transactions are subject to a refund processing fee of 0.25 CAD. To avoid this processing fee try voiding the payment instead (see Voids).
