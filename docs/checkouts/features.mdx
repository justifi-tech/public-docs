...
- After creating a Checkout, use the [Unified Fintech Checkout™ Component with insurance](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index)
...
- After creating a Checkout, use the [Unified Fintech Checkout™ Component](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index)
  with the BNPL option (default).

_note: Disable the BNPL option by passing the correspondent prop to the web component:
[disable-bnpl](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index)_
...
- **Checkout Web Component:** Use the [Unified Fintech Checkout™ Component](/web-components/payment-facilitation/unified-fintech-checkout%E2%84%A2/index)
