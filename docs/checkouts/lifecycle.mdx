...
The deprecated `application_fees` field will be `null` when using the new `fees` structure. See [Fees documentation](/docs/checkouts/features#fees) for more details.
:::
