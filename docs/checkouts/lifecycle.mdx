...
description: Understand a Checkout lifecycle
keywords:
  - checkouts
  - features
  - lifecycle
...
- When a Checkout is created it status is set to `created`.
...
- **Important:** this history is not updated if the payment is refunded.
