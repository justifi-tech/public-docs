...
JustiFi hosted checkout has default behavior and redirects for when a checkout is completed successfully or has expired. If the desired behavior is to redirect back to your application upon completion of the checkout, you can use the `success_redirect_url` parameter to override the default redirect:
