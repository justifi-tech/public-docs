...
description: How to use Hosted Checkout
keywords:
  - checkouts
  - features
---
...
```components.justifi.ai/hosted-checkout/:checkoutId```
...
```components.justifi.ai/hosted-checkout/cho_abc123def456?success_redirect_url=https://yourapp.com/payment-success```