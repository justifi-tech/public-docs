...
import FintechProductsImg from "../../static/img/definition-fintech-products-new.png";
import CrossbarCaseStudyImg from "../../static/img/success-stories-new.png";
import EngageImg from "../../static/img/engage-new.png";
