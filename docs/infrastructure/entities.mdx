...
import definitionentities from "../../static/img/definition-identity-new.png";
import definitionbusiness from "../../static/img/definition-business-new.png";
...
<img
  src={definitionentities}
  alt="Definition of Identity"
  type="image/png"
  object-fit="contain"
  width="100%"
  height="100%"
...
<img
  src={definitionbusiness}
  alt="Definition of Business"
  type="image/png"
  object-fit="contain"
  width="100%"
  height="100%"
