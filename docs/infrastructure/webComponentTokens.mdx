...
Open the file OR go to [http://localhost:8000/payment_details.html](http://localhost:8000/payment_details.html), you should see the [payment details web component](/web-components/merchant-tools/payout-details/index):
...
Open the file or go to [http://localhost:8000/payment_list.html](http://localhost:8000/payment_list.html), you should see the [payment list web component](/web-components/merchant-tools/payments-list/index):

![PaymentList](../../static/img/wc_payment_list.png)

### Create a business and render the Payment Provisioning component

The following steps shows how to create a business entity, generate a web component token, and render the [PaymentProvisioning web component](/web-components/entities/payment-provisioning/index):
